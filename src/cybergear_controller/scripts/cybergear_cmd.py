...
class CBG_CMD_Node(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("CyberGear_cmd_node has been executed")


        
        # self.get_logger().info("Adjust")
        # time.sleep(5.0)
        for id in [1,4]:
            self.set_runmode(id, 1)
            self.set_limit_cur(id, 23.0)
            self.set_limit_spd(id,4.0)
            self.start_motor(id)

        time.sleep(2.0)
        self.get_logger().info("stand")
        self.set_loc_ref(1, 0.0)
        self.set_loc_ref(4, 0.0)

        time.sleep(2.0)
        self.get_logger().info("stand")
        self.set_loc_ref(1, 0.4)
        self.set_loc_ref(4, 0.4)
        ...
        time.sleep(2.0)
        self.get_logger().info("stand")
        self.set_loc_ref(2, 0.2)
        self.set_loc_ref(5, -0.2)
        ...
        self.set_loc_ref(3, -0.2)
        self.set_loc_ref(6, +0.2)
