...
def generate_launch_description():
    socket_can_receiver_node = LifecycleNode(
        ...
        parameters=[{
            ...
            'enable_frame_loopback': PythonExpression(["'", LaunchConfiguration('enable_frame_loopback'), "' == 'true'"]),
            'interval_sec': LaunchConfiguration('interval_sec'),
            'filters': LaunchConfiguration('filters'),
            'use_bus_time': PythonExpression(["'", LaunchConfiguration('use_bus_time'), "' == 'true'"]),
        }],
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('filters', default_value='0:0',
                              description='Comma separated filters can be specified for each given'
                                          ...
                                          "'0:0' default filter will accept all data frames.\n"
                                          'For more information about syntax check: https://manpages.ubuntu.com/manpages/jammy/man1/candump.1.html'),
